<?php
	...
	$sql = "SELECT * FROM peluqueria WHERE veteid='$id' ORDER BY fecha DESC"; 
...
<tr>
	...
	<td width=""    align="center" style="background-color:#eeeDDD;" class="tertiary-text"><B>TRABAJO</B></td>
...
while($row = mysql_fetch_assoc($result)) {
		...
		<td width=""  valign="top" class="tertiary-text"><?php echo $row['trabajo'];?><br><br></td>
