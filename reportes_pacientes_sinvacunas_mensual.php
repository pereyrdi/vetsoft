<?php
	...
	$titulo="Mascotas sin vacunar durante el mes de ".$meses[date("n")];
?>
<?php
	//aquellos veteid que esten en la tabla vete pero no esten en la tabla vacunas
	...
	$sql="SELECT veteid FROM vacunas WHERE MONTH(fecha) = MONTH(CURDATE())";
	$result = mysql_query($sql);
